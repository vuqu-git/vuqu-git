...
* ⚡ Fun Fact: **Ich verbinge durchaus viel Zeit in einem großen, dunklen Raum: Gemeint ist ein Kinosaal (>100 im Jahr)**.

### 💻 Tech Stack & Tools

| Kategorie | Tools & Technologien | 
 | ----- | ----- | 
| **Sprachen** | `JavaScript` / `TypeScript`, `Python`, `SQL`, `VBA` | 
